    ...
    def register_literals(literals, negated):
        for literal in literals:
            if literal.positive() in axioms_by_atom:   # This is an axiom literal
                ...
                if literal.positive() not in necessary_literals:
                    # add only the positive of the literal to the set;
                    # this seems to ensure that all derived propositions
                    # have false as their default, so that axioms derive
                    # positive values only.
                    necessary_literals.add(literal.positive())
